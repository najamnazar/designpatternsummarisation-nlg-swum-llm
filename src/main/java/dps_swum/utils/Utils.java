...
/**
 * Utility class providing helper methods for file operations, string manipulation,
 * and data extraction from parsed code structures.
 * <p>
 * This class contains static utility methods used throughout the SWUM module for
 * common operations like file handling, name parsing, and extracting specific
 * details from the HashMap-based class representations produced by JavaParser.
 * </p>
 * <p>
 * Key functionalities:
 * <ul>
